...
The central argument is simple and contestable: the professional advantage in Introductory Statistics no longer comes from doing every step by hand. It comes from knowing what to delegate, what to verify, what to reject, and what human judgment must still own because the consequences attach to a person, a community, an institution, or a client.
...
Introductory Statistics: with LLMs is a guided course in the concepts, workflows, and judgment calls that define Introductory Statistics in the AI era. It teaches vocabulary, recurring patterns, practical exercises, and the discipline of checking machine output against human purpose.
...
1. **Chapter 1 — Sampling and Data** — This chapter develops one part of the book's argument and gives the reader a concrete place to practice it.
2. **Chapter 2 — Descriptive Statistics** — This chapter develops one part of the book's argument and gives the reader a concrete place to practice it.
3. **Chapter 3 — Probability Topics** — This chapter develops one part of the book's argument and gives the reader a concrete place to practice it.
4. **Chapter 4 — Discrete Random Variables** — This chapter develops one part of the book's argument and gives the reader a concrete place to practice it.
5. **Chapter 5 — Continuous Random Variables** — This chapter develops one part of the book's argument and gives the reader a concrete place to practice it.
6. **Chapter 6 — The Normal Distribution** — This chapter develops one part of the book's argument and gives the reader a concrete place to practice it.
7. **Chapter 7 — The Central Limit Theorem** — This chapter develops one part of the book's argument and gives the reader a concrete place to practice it.
8. **Chapter 8 — Confidence Intervals** — This chapter develops one part of the book's argument and gives the reader a concrete place to practice it.
9. **Chapter 9 — Hypothesis Testing with One Sample** — This chapter develops one part of the book's argument and gives the reader a concrete place to practice it.
10. **Chapter 10 — Hypothesis Testing with Two Samples** — This chapter develops one part of the book's argument and gives the reader a concrete place to practice it.
11. **Chapter 11 — The Chi-Square Distribution** — This chapter develops one part of the book's argument and gives the reader a concrete place to practice it.
12. **Chapter 12 — The F-Distribution and One-Way ANOVA** — This chapter develops one part of the book's argument and gives the reader a concrete place to practice it.
13. **Chapter 13 — Linear Regression and Correlation** — This chapter develops one part of the book's argument and gives the reader a concrete place to practice it.
...
Introductory Statistics, AI+1, Humanitarians AI, Irreducibly Human, agentic AI, computational skepticism
